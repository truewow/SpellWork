...
namespace SpellWork.DBC
{
    ...
    public struct SpellEntry
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = DBCStore.MaxReagentCount)]
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = DBCStore.MaxEffectIndex)]
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = DBCStore.MaxDbcLocale)]
        ...
        {
            get { return _SpellName == null ? DBCStore.SpellStringsFromDB.GetValue(ID) : DBCStore.SpellStrings.GetValue(_SpellName[(uint)DBCStore.Locale]); }
        }
        ...
        public string Rank
        {
            get { return (_Rank != null && _Rank[(uint)DBCStore.Locale] != 0) ? DBCStore.SpellStrings[_Rank[(uint)DBCStore.Locale]] : string.Empty; }
        }
        ...
        {
            get { return _Description == null ? string.Empty : DBCStore.SpellStrings.GetValue(_Description[(uint)DBCStore.Locale]); }
        }
        ...
        {
            get { return _ToolTip == null ? string.Empty : DBCStore.SpellStrings.GetValue(_ToolTip[(uint)DBCStore.Locale]); }
        }

        public string GetName(byte loc)
        {
            return _SpellName == null ? DBCStore.SpellStringsFromDB.GetValue(ID) : DBCStore.SpellStrings.GetValue(_SpellName[loc]);
        }
        ...
        {
            get { return DBCStore.SpellDuration.ContainsKey(DurationIndex) ? DBCStore.SpellDuration[DurationIndex].ToString() : String.Empty; }
        }
        ...
        public string Range
        {
            get
            {
                if (RangeIndex == 0 || !DBCStore.SpellRange.ContainsKey(RangeIndex))
                    return String.Empty;

                var range = DBCStore.SpellRange[RangeIndex];
                var sb = new StringBuilder();
        ...
        public string GetRadius(int index)
        {
            ...
            if (rIndex != 0)
                return DBCStore.SpellRadius.ContainsKey(rIndex) ? String.Format("Radius (Id {0}) {1:F}", rIndex, DBCStore.SpellRadius[rIndex].Radius) : String.Format("Radius (Id {0}) Not found", rIndex);
        ...
        public string CastTime
        {
            get
            {
                ...
                return !DBCStore.SpellCastTimes.ContainsKey(CastingTimeIndex)
                           ? String.Format("CastingTime (Id {0}) = ????", CastingTimeIndex)
                           : String.Format("CastingTime (Id {0}) = {1:F}", CastingTimeIndex,
                                           DBCStore.SpellCastTimes[CastingTimeIndex].CastTime / 1000.0f);
            }
        }
    ...
    public struct SkillLineEntry
    {
        ...
        public string Name
        {
            get { return DBCStore.SkillLineStrings.GetValue(InternalName[(uint)DBCStore.Locale]); }
        }

        public string Description
        {
            get { return DBCStore.SkillLineStrings.GetValue(InternalDescription[(uint)DBCStore.Locale]); }
        }

        public string AlternateVerb
        {
            get { return DBCStore.SkillLineStrings.GetValue(InternalAlternateVerb[(uint)DBCStore.Locale]); }
        }
    };
    ...
    public struct SpellRangeEntry
    {
        ...
        {
            get { return DBCStore.SpellRangeStrings.GetValue(Desc1[(uint)DBCStore.Locale]); }
        }

        public string Description2
        {
            get { return DBCStore.SpellRangeStrings.GetValue(Desc2[(uint)DBCStore.Locale]); }
        }
    };
    ...
    public struct ScreenEffectEntry
    {
        ...
        public string Name
        {
            get { return DBCStore.ScreenEffectStrings.GetValue(InternalName); }
        }
    };
    ...
    public struct SpellMissileMotionEntry
    {
        ...
        public string Name
        {
            get { return DBCStore.SpellMissileMotionStrings.GetValue(_Name); }
        }

        public string Script
        {
            get { return DBCStore.SpellMissileMotionStrings.GetValue(_Script); }
        }
    };
    ...
    public struct AreaTableEntry
    {
        ...
        public string Name
        {
            get { return DBCStore.AreaStrings.GetValue(NamePtr[(uint)DBCStore.Locale]); }
        }
    };
    //=============== DateBase =================\\
