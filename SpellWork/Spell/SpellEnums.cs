...
namespace SpellWork.Spell
{
    ...
    public enum SpellAtributeEx : uint
    {
        ...
        SPELL_ATTR1_PREVENTS_ANIM                    = 0x00040000, // 18 auras apply UNIT_FLAG_PREVENT_EMOTES_FROM_CHAT_TEXT
    ...
    public enum SpellAtributeEx3 : uint
    {
        ...
        SPELL_ATTR3_TREAT_AS_PERIODIC                = 0x02000000, // 25 no cause spell pushback ?
    ...
    public enum SpellAtributeEx4 : uint
    {
        ...
        SPELL_ATTR4_DONT_REMOVE_IN_ARENA             = 0x00200000, // 21 Keep when entering arena
        ...
        SPELL_ATTR4_INHERIT_CRIT_FROM_AURA           = 0x08000000, // 27
    ...
    public enum SpellAtributeEx7 : uint
    {
        ...
        SPELL_ATTR7_CANT_DODGE                       = 0x00800000, // 23 Spell cannot be dodged
        SPELL_ATTR7_CANT_PARRY                       = 0x01000000, // 24 Spell cannot be parried
        SPELL_ATTR7_CANT_MISS                        = 0x02000000, // 25 Spell cannot be missed
    ...
    public enum SpellInterruptFlags : uint
    {
        ...
        SPELL_INTERRUPT_FLAG_ALL          = SPELL_INTERRUPT_FLAG_MOVEMENT | SPELL_INTERRUPT_FLAG_PUSH_BACK | SPELL_INTERRUPT_FLAG_UNK3 |
                                            SPELL_INTERRUPT_FLAG_INTERRUPT | SPELL_INTERRUPT_FLAG_ABORT_ON_DMG
    ...
    public enum SpellChannelInterruptFlags : uint
    {
        ...
        CHANNEL_INTERRUPT_FLAG_ALL          = CHANNEL_INTERRUPT_FLAG_INTERRUPT | CHANNEL_FLAG_DELAY
    };
    ...
    public enum SpellAuraInterruptFlags : uint
    {
        ...
        AURA_INTERRUPT_FLAG_UNK1                        = 0x04000000,   // 26
        AURA_INTERRUPT_FLAG_UNK2                        = 0x08000000,   // 27,
        AURA_INTERRUPT_FLAG_UNK3                        = 0x10000000,   // 28,
        AURA_INTERRUPT_FLAG_UNK4                        = 0x20000000,   // 29,
        AURA_INTERRUPT_FLAG_UNK5                        = 0x40000000,   // 30
    ...
    public enum EquipmentSlots : int                                 // 19 slots
    {
        EQUIPMENT_SLOT_ALL          = -1,
